...
excel_path = r"C:\Users\DELL\Desktop\Jupyter\Projet_Sargalert\Notebooks\points_info_goes.xlsx"  # Remplacez par le chemin réel du fichier
...
regions = Translation.regions_sarg_goes  
points_info = []
...
for i, region in enumerate(regions):
    ...
    maxr = min(Translation.fai_mod_np.shape[0], maxr + extend)
    maxc = min(Translation.fai_mod_np.shape[1], maxc + extend)
    roi_mod = Translation.fai_mod_np[minr:maxr, minc:maxc]
    roi_myd = Translation.fai_myd_np[minr:maxr, minc:maxc]
    ...
    roi_sarg_mod = Translation.fai_sarg_mod_np[minr:maxr, minc:maxc]
    roi_sarg_myd = Translation.fai_sarg_myd_np[minr:maxr, minc:maxc]
    liste_roi_mod = []
    liste_roi_myd = []
