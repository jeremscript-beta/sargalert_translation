...
filecur = 'cmems_mod_glo_phy-cur_anfc_0.083deg_PT6H-i_1721739106099.nc';
...
save('U_truth.mat', "time", "lat", "lon", "uRad", "vRad", "msk");

disp('U_truth.mat file created successfully.');
